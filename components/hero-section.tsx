...
export function HeroSection() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-background via-card to-background overflow-hidden lg:pt-10 ">
      <video
        src="/shoe-spa.mp4"
        autoPlay
        loop
      ...
      <div className="relative mx-auto max-w-7xl p-8 flex flex-col items-center text-center">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.div variants={item} className="mb-2 2xl:mt-10">
          ...
          <motion.h1
            variants={item}
            className="text-5xl sm:text-6xl font-bold text-foreground mb-6 tracking-tight"
          >
            Your{" "}
          ...
          >
            Get free pickup & delivery, eco-friendly cleaning, and updates on
            WhatsApp. Experience pristine garments and restored sneakers in just
            one day.
          </motion.p>
          ...
          <motion.div
            variants={item}
            className="flex flex-col sm:flex-row items-center justify-center gap-6 text-base"
          >
            <motion.div
              whileHover={{ scale: 1.05 }}
            ...
            <span className="text-foreground/70">
              Serving Delhi, Gurgaon, Noida & Ghaziabad
            </span>
          </motion.div>
        </motion.div>
